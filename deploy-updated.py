#!/usr/bin/env python3
"""
Deploy updated agentic-enterprise presentation to Snowhouse SPCS.
Uses existing TEMP.MMARZILLO_COCO schema and service.
"""
...
if not services:
    print("ERROR: No service found in TEMP.MMARZILLO_COCO")
    sys.exit(1)
...
run("~/Library/Python/3.11/bin/snow spcs image-registry login --connection SNOWHOUSE_AWS_US_WEST_2")
