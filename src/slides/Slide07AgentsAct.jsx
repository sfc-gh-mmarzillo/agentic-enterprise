      ...
      <div className="mt-5 grid w-full flex-1 grid-cols-2 gap-5">
        ...
        <div className="rounded-2xl border border-sf-line bg-white/70 p-5">
          <div className="flex items-center gap-2">
            <span className="grid h-8 w-8 place-items-center rounded-lg bg-sf-blue/10 p-1.5">
              <img src="/logos/snowflake.png" alt="Snowflake" style={{ display: 'block', width: '100%', height: '100%', objectFit: 'contain' }} />
            </span>
            <div>
