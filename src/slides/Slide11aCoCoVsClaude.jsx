...
export default function Slide11aCoCoVsClaude() {
  return (
    <div className="flex h-full w-full flex-col items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 px-16 py-12">
      ...
      >
        <h1 className="text-[48px] font-black text-slate-900 mb-2">CoCo vs. Claude Code</h1>
      ...
      <div className="w-full max-w-[1100px] grid grid-cols-2 gap-6 mb-8">
        {/* Claude Code Column */}
        <motion.div
          initial={{ opacity: 0, x: -20 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ delay: 0.2 }}
          className="bg-white/80 backdrop-blur-sm rounded-2xl border-2 border-orange-200 p-6 shadow-lg"
        >
          <div className="flex items-center justify-center mb-6">
            <div className="bg-orange-100 px-6 py-2 rounded-full">
              <h2 className="text-[16px] font-bold text-slate-700">Claude Code</h2>
            </div>
          </div>
          
          <div className="mb-6">
            <h3 className="text-[20px] font-bold text-orange-600 mb-4">A General Purpose Coding Agent</h3>
          </div>

          <div className="space-y-6">
            <div>
              <h4 className="text-[14px] font-bold text-slate-900 mb-3">Enterprise AI Coding Productivity</h4>
            ...
            <div>
              <h4 className="text-[14px] font-bold text-slate-900 mb-3">Tokenomics</h4>
              <ul className="space-y-2.5 text-[13px] text-slate-700">
                <li className="flex gap-2">
                  <span className="text-orange-500 font-bold">•</span>
        ...
        <motion.div
          ...
          animate={{ opacity: 1, x: 0 }}
          transition={{ delay: 0.2 }}
          className="bg-white/80 backdrop-blur-sm rounded-2xl border-2 border-blue-300 p-6 shadow-lg"
        >
          <div className="flex items-center justify-center mb-6">
            <div className="bg-blue-500 px-6 py-2 rounded-full">
              <h2 className="text-[16px] font-bold text-white">CoCo</h2>
            </div>
          </div>
          
          <div className="mb-6">
            <h3 className="text-[20px] font-bold text-blue-600 mb-4">Built For Data-Intensive AI Coding</h3>
          </div>
      ...
      <motion.div
        ...
        className="w-full max-w-[1100px] bg-white/60 backdrop-blur-sm rounded-xl border border-slate-300 p-5"
      >
        <div className="flex items-start gap-8">
          <div className="flex items-center gap-3 min-w-[140px]">
            <span className="text-[14px] font-bold text-slate-700">Risks &<br/>Impact</span>
          </div>
