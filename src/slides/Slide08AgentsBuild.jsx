      ...
      <div className="mt-5 grid w-full flex-1 grid-cols-2 gap-5">
        ...
        <div className="rounded-2xl border border-sf-line bg-white/70 p-5">
          <div className="flex gap-2">
            <span className="rounded-full bg-sf-purple px-3 py-1 text-[12px] font-medium text-white">Agentic Action</span>
            <span className="rounded-full px-3 py-1 text-[12px] text-sf-mist">Features</span>
          </div>
