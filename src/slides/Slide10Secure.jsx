...
export default function Slide10Secure() {
  ...
  return (
    <div className="flex h-full w-full flex-col pt-1">
      ...
      <div className="mt-4 grid flex-1 grid-cols-[1fr_1fr_0.9fr] gap-4">
        {DEEPDIVE.map((d) => (
      ...
      <p className="mt-3 text-center text-[10px] text-sf-mist">
        ⅔ of leaders cite security as the #1 barrier to scaling agentic AI · Gartner: &gt;50% of agent attacks through 2029 exploit access control &mdash; Snowflake closes both.
      </p>
    </div>
  )
}
